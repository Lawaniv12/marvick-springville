...
export class PortfolioService {
  ...
  projects = signal<Project[]>([
    ...
    },
    {
      ...
      tag: 'Education',
      url: 'https://www.sun.edu.ng/',
      desc: 'Full institutional website for a Nigerian university — admissions, programmes, faculty pages, news and student portal integration.',
      screenshotUrl: this.SS('https://www.sun.edu.ng/'),
